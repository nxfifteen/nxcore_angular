...
@Component({
  templateUrl: './categoryoverview.component.html'
})
export class CategoryOverviewComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.currentUser.firstrun) {
      ...
      this._matomoService.setupTracking('Core | Exercise Category Overview');
  ...
  buildViewContent(bustCache?: boolean): void {
    ...
    this.apiService.getExercisesCategoryOverview(bustCache).subscribe((data) => {
