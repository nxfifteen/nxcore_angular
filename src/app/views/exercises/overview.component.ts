...
import {ExercisesSummary} from '../../_models/exercisesCategories';
...
export class OverviewComponent implements OnInit {
  ...
  currentUser: User;
  exerciseMetaData: Array<ExercisesSummary>;
  ...
  ngOnInit() {
    ...
    if (this.currentUser.firstrun) {
      ...
      this._matomoService.setupTracking('Core | Exercise Overview');
  ...
  buildViewContent(bustCache?: boolean): void {
    ...
    this.apiService.getExercisesOverview(bustCache).subscribe((data) => {
